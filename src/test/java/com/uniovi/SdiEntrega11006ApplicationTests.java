...
@SpringBootTest
public class SdiEntrega11006ApplicationTests {
	...
	public void P01() {
		...
		PO_RegisterView.fillForm(driver, "juan@mail.com", "JoseJose", "Ramon", "123456", "123456");
	...
	public void P03() {
		...
		PO_HomeView.clickOption(driver, "signup", "class", "btn btn-primary");
		// Rellenamos el formulario.
		PO_RegisterView.fillForm(driver, "juan@mail.com", "Jose", "Ramon", "1234567", "123456");
	...
	public void P04() {
		...
		PO_HomeView.clickOption(driver, "signup", "class", "btn btn-primary");
		// Rellenamos el formulario.
		PO_RegisterView.fillForm(driver, "usuario1@gmail.com", "Jose", "Ramon", "123456", "123456");
	...
	public void P06() {
		...
		PO_HomeView.clickOption(driver, "login", "class", "btn btn-primary");
		// Rellenamos el formulario
		PO_LoginView.fillForm(driver, "usuario1@gmail.com", "123456");
		// // COmprobamos que entramos en la pagina privada del usuario
	...
	public void P08() {
		...
		PO_HomeView.clickOption(driver, "login", "class", "btn btn-primary");
		// Rellenamos el formulario
		PO_LoginView.fillForm(driver, "usuario1@gmail.com", "123456444");
		// // COmprobamos que entramos en la pagina privada del usuario
	...
	public void P09() {
		...
		PO_HomeView.clickOption(driver, "login", "class", "btn btn-primary");
		// Rellenamos el formulario
		PO_LoginView.fillForm(driver, "notusuario1@gmail.com", "123456");
		// // COmprobamos que entramos en la pagina privada del usuario
		PO_View.checkElement(driver, "text", "Email o contraseña inválido.");
	}
	...
	public void P24() {
		...
		PO_PrivateView.search(driver, "supervivencia de montaña");
		WebElement button = driver.findElement(By.partialLinkText("Comprar"));
		button.click();
	...
	public void P25() {
		...
		WebElement button = driver.findElement(By.partialLinkText("Comprar"));
		button.click();
		PO_View.checkElement(driver, "text", "No tienes tanto dinero para la compra seleccionada");
